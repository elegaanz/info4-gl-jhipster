...
import xyz.gelez.gl.dm.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "1Gsl@IjV^svwhar";
    private static final String UPDATED_EMAIL = "uPJ@zywexq";

    private static final String DEFAULT_TELEPHONE = " 428";
    private static final String UPDATED_TELEPHONE = "98";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).adresse(DEFAULT_ADRESSE).email(DEFAULT_EMAIL).telephone(DEFAULT_TELEPHONE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL).telephone(UPDATED_TELEPHONE);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL).telephone(UPDATED_TELEPHONE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL).telephone(UPDATED_TELEPHONE);
