  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="dmApp.livreur.home.createOrEditLabel" data-cy="LivreurCreateUpdateHeading">
            <Translate contentKey="dmApp.livreur.home.createOrEditLabel">Create or edit a Livreur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('dmApp.livreur.nom')}
                id="livreur-nom"
                name="nom"
                data-cy="nom"
                type="text"
