  ...
  return (
    <div>
      <h2 id="livreur-heading" data-cy="LivreurHeading">
        <Translate contentKey="dmApp.livreur.home.title">Livreurs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dmApp.livreur.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/livreur/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dmApp.livreur.home.createLabel">Create new Livreur</Translate>
          </Link>
        </div>
      </h2>
        ...
        {livreurList && livreurList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="dmApp.livreur.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="dmApp.livreur.nom">Nom</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dmApp.livreur.home.notFound">No Livreurs found</Translate>
            </div>
          )
        )}
      </div>
